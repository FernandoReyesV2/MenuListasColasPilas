...
while True:
    try:
        tam = int(input("Ingres el tamaño de la lista/pila/cola: "))
        break
    except ValueError:
        print("Dato no válido, por favor ingrese un número")
pila1 = Pila(tam)
    ...
    if opc == "1":
        ...
        while opc2 != "6":
            ...
            if opc2 == "1":
                ...
                for i in range(tam):
                    dato = int(input("Ingrese el numero que desea ingresar a la cola: "))
                    cola1.insentar(dato)
                    print("Dato ingresado")
                input("---Presione una tecla para continuar---")
            elif opc2 == "2":
                ...
                x = int(input("Cuantos elemento desea quitar de la cola: "))
                if x <= tam:
                    for i in range(x):
